...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private UnityEngine.UI.Image map;
    [SerializeField] private UnityEngine.UI.Image Clear3;
    [SerializeField] private UnityEngine.UI.Image NEXT3;
    ...
    void Update()
    {
        ...
        if (!shuffling&& CheckCompletion())
        {
            ...
            else if(b==1)
            {
                ...
                {
                    SceneManager.LoadScene("Stage4Story1");
                }
            }
        }
